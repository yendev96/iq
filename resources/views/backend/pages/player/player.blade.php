    ...
    <div class="panel-heading my-panel-heading">
        <div class="row">
            <div class="col-md-4 col-ms-12 title-panel">
                <h3>Player Manager ({{count($data)}})</h3>
            </div>
        </div>
    </div>
            ...
            <div class="col-lg-12">
                <div class="margin-bottom-50">
                    <div id="example1_wrapper" class="dataTables_wrapper form-inline dt-bootstrap4">
                        <div class="row">
                            <form action="{{url('backend/player')}}" class="myformplayer" method="get" accept-charset="utf-8">
                                <div class="col-md-9">
                        ...
                        <div class="row">
                            <form action="{{url('backend/player/delete')}}" method="post">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd">
                                                ...
                                                <td style="text-align: right;">
                                                    <a href="{{url('backend/player/delete', $item->id)}}" title=""><i class="fa fa-trash my-fa-delete delete-user"></i></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
